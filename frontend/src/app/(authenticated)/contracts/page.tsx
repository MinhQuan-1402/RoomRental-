  ...
  return (
    <div style={styles.root}>
      <div style={styles.pageHeader}>
        <div>
          <h1 style={styles.title}>Hợp đồng</h1>
          <p style={styles.subtitle}>Quản lý hợp đồng thuê phòng</p>
        </div>
      ...
      <ShellTable
        columns={["Mã HĐ", "Phòng", "Người thuê", "Ngày bắt đầu", "Ngày kết thúc", "Giá thuê", "Trạng thái"]}
        emptyMessage="Chưa có hợp đồng nào"
        emptyHint="Tạo hợp đồng khi có phòng trống và người thuê"
      />
    </div>
  );
}
